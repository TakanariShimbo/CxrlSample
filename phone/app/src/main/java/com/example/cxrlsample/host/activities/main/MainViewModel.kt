package com.example.cxrlsample.host.activities.main
...
import com.example.cxrlsample.host.activities.customAppType.CustomAppTypeActivity
import com.example.cxrlsample.host.activities.customViewType.CustomViewTypeActivity
...
class MainViewModel: ViewModel() {
    ...
    fun checkAuthorizationResult(requestCode: Int, data: Intent?) {
        val result = AuthorizationHelper.parseAuthorizationResult(requestCode, data)
